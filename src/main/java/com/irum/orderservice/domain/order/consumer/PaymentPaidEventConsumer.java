...
public class PaymentPaidEventConsumer {
    ...
    public void processDlt(@Payload PaymentPaidEvent event,
        ...
        log.error("원본 토픽 : {} \t 원본 오프셋 : {} \t 원본 파티션 : {} \t 원본 컨슈머 그룹 : {}", originalTopic, originalOffset, originalPartition, originalConsumerGroup);
